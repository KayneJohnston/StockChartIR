...
Generated 2026-09-03 09:49 UTC.
...
| --- | --- | --- | --- | --- |
| Low inflation | 17333 | 7.493 | 0.089 | 0.154 |
| Moderate | 36693 | 11.244 | 0.108 | 0.202 |
| High inflation | 41953 | 12.073 | 0.142 | 0.272 |

**When the state variable is read decides whether it matters at all.** Retiring into the high-inflation third rather than the low one is worth -8.59% of certainty-equivalent retirement consumption. Conditioning the same lifetimes on the inflation they *began* at is worth +0.10% -- 82.3 times smaller, and of the opposite sign. The null above was a statement about the horizon, not about inflation. A sixty-eight-year lifetime averages a short-horizon shock away; a thirty-year decumulation cannot.
...
| Inflation at retirement | Optimal equity share from retirement | CEC there | Over holding no equity (%) | Over the next grid point (%) |
| --- | --- | --- | --- | --- |
| Low inflation | 0.900 | 1.084 | 11.148 | 0.171 |
| Moderate | 1.000 | 1.114 | 13.929 | 0.035 |
| High inflation | 1.000 | 0.989 | 13.400 | 0.458 |

| Inflation at retirement | Optimal domestic share from retirement | CEC there | Over all-international (%) | Over the next grid point (%) |
| --- | --- | --- | --- | --- |
| Low inflation | 0.300 | 1.090 | 0.879 | 0.023 |
| Moderate | 0.200 | 1.137 | 0.406 | 0.046 |
| High inflation | 0.200 | 1.010 | 0.653 | 0.142 |

**The retiree's optimum moves with the regime.** The equity share runs 90% to 100% from the calm third to the hot one, and the domestic share 30% to 20%. At least one of those sits inside the grid's resolution and should be read against the margin columns rather than as a clean identification.
...
* `results/figures/fig54_inflation_timing.png`
