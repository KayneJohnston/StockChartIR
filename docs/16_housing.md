...
Generated 2026-08-29 08:20 UTC.
...
the same 2,000 lifetimes and the same income draws, so the
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 0.00 | 45.00 | 0.00 | 55.00 | 0.00 | 0.00 | 1.33 | 12.17 |
| 2.00 | 25.00 | 5.00 | 70.00 | 0.00 | 0.00 | 1.21 | 2.65 |
| 4.00 | 0.00 | 10.00 | 90.00 | 0.00 | 0.00 | 1.18 | 0.00 |

**Housing is worth holding below an annual cost of 3.9% and not above it.** At no cost the optimum puts 45% of the portfolio in it, worth 12.2% in certainty-equivalent consumption over the best four-asset portfolio on the same paths; that gain falls away as the cost rises and reaches zero at 3.9% a year.

The weight comes out of **international equity**, which falls 35% of the portfolio between the dearest and the free case -- more than any other asset gives up. That is the economically interesting part: housing competes with the sleeve it most resembles, not with the portfolio as a whole.

## 5. Is the answer an artefact of the smoothing?

Left smoothed, the same search puts 50% in housing at zero cost against 45% once the smoothing is undone, and its break-even cost is 3.9% against 3.9%. The naive treatment therefore **overstates** the case for housing, which is the direction the mechanism predicts: smoothing hides volatility, and hidden volatility looks like risk-adjusted return.
...
| --- | --- | --- | --- | --- | --- | --- |
| 0.00 | 42.21 | 37.89 | 47.67 | 45.00 | 1.34 | 1.33 |

Letting the allocation vary with age moves the mean housing weight by at most 3% of the portfolio and buys at most 1.33% more certainty-equivalent consumption -- large enough that the constant-mix reading above should be treated as indicative only.
