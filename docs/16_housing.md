...
The weight comes out of **international equity**, which falls 40% of the portfolio between the dearest and the free case -- more than any other asset gives up. Bonds, bills are untouched at every cost, so housing is not substituting for the portfolio at large: it is competing with the one holding that already does this job.
