...
| --- | --- | --- | --- | --- |
| start | -1 | 0.90340 | -- | 1 |
| coarse | 0 | 1.11231 | 23.12547 | 2381 |
| coarse | 1 | 1.11604 | 0.33525 | 4761 |
| fine | 0 | 1.11888 | 0.25435 | 5111 |
| fine | 1 | 1.12001 | 0.10132 | 5530 |
| fine | 2 | 1.12015 | 0.01226 | 5958 |
| fine | 3 | 1.12030 | 0.01303 | 6383 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 2.0 | working | 38 | 0.0 | 100.0 | 0.0 | 0.0 | 100.0 |
| 2.0 | retired | 30 | 12.7 | 85.5 | 0.0 | 1.8 | 98.2 |
| 5.0 | working | 38 | 6.1 | 93.9 | 0.0 | 0.0 | 100.0 |
| 5.0 | retired | 30 | 13.5 | 83.8 | 0.7 | 2.0 | 97.3 |
| 10.0 | working | 38 | 12.9 | 85.8 | 1.2 | 0.1 | 98.7 |
| 10.0 | retired | 30 | 13.0 | 79.3 | 2.8 | 4.8 | 92.3 |

At the baseline preference (γ = 5) the solved portfolio averages
**9.3% domestic equity and 89.5% international equity**, with
0.3% in bonds and 0.9% in bills.
...
15-country leave-one-out average, better
...
89% international is that the model prefers *more* diversification than
...
The fixed-income sleeve is barely used at all — bonds average 0.3% of the portfolio and bills 0.9% across the whole lifecycle — so the 70/30 bond/bill split that `docs/07` fixed in advance was fixing the composition of something the optimiser does not want to hold.

## 3. Against the benchmarks

| Schedule | CEC | Gap to best (%) |
| --- | --- | --- |
| full_simplex_optimal | 1.1203 | 0.0000 |
| docs07_free_form | 1.1170 | -0.2957 |
| docs07_parametric | 1.1147 | -0.4992 |
| international_equity | 1.1060 | -1.2753 |
| balanced_all_equity | 1.0449 | -6.7334 |
| target_date_fund | 0.9410 | -16.0075 |
| domestic_equity | 0.8807 | -21.3896 |
| sixty_forty | 0.8702 | -22.3265 |
| bills_only | 0.7380 | -34.1275 |

The solved schedule leads the best fixed benchmark by **0.30%** at
...
| --- | --- | --- | --- | --- | --- | --- |
| 63 | retired | 16.50 | 15.00 | 55.00 | 0.00 | 30.00 |
| 64 | retired | 13.66 | 20.00 | 60.00 | 0.00 | 20.00 |
| 65 | retired | 8.64 | 25.00 | 65.00 | 0.00 | 10.00 |
| 70 | retired | 5.49 | 20.00 | 80.00 | 0.00 | 0.00 |
| 67 | retired | 1.94 | 15.00 | 85.00 | 0.00 | 0.00 |
| 56 | working | 1.92 | 20.00 | 80.00 | 0.00 | 0.00 |
| 38 | working | 1.78 | 0.00 | 100.00 | 0.00 | 0.00 |
| 58 | working | 1.77 | 15.00 | 85.00 | 0.00 | 0.00 |
| 39 | working | 1.74 | 0.00 | 100.00 | 0.00 | 0.00 |
| 74 | retired | 1.70 | 20.00 | 80.00 | 0.00 | 0.00 |

Of the 68 ages at γ = 5, **33** move the objective
...
Working years each cost about 1.1 basis points on average and
retired years 2.0, but the retired average is carried almost
entirely by the first few. **The magnitudes remain small in absolute terms** —
the largest single age is worth 16.5 basis
points, and the whole schedule beats the best fixed benchmark by only
0.30% — so the honest summary is that the *timing* of the allocation
...
| --- | --- | --- | --- | --- | --- | --- |
| 0.25 / 0.25 / 0.25 / 0.25 | 1.1203 | 0.0000 | 9.3382 | 89.4853 | 0.2941 | 0.8824 |
| 0.50 / 0.50 / 0.00 / 0.00 | 1.1201 | -0.0156 | 10.6618 | 88.4559 | 0.0000 | 0.8824 |
| 0.00 / 0.00 / 0.50 / 0.50 | 1.1201 | -0.0205 | 10.0735 | 88.8971 | 0.2206 | 0.8088 |

The restarts agree to within **0.021%** of each other. That is
...
* The gain from solving the whole simplex rather than a restricted version of
  it is 0.30%, which belongs in the same category as the currency-hedging
...
Runtime 1091s at 20,000 paths. Tables in
