...
**The eligibility gate pushes the date later, and by a lot.** On the same voluntary saving, an age-gated pension moves the best date from 60 to 67 -- 7 years. Nothing about the investor changed; what changed is that stopping early no longer starts the pension.

**And compulsory saving buys most of it back.** Adding the Superannuation Guarantee moves the date from 67 to 62, recovering 5 of the 7 the gate cost. The two halves of the Australian system pull in opposite directions on this question, which is why a single Australia-versus-America row would say nothing.
